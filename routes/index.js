...
//             db.exec(`CREATE TABEL myTable (
//                      blog_id INTEGER PRIMARY KEY AUTOINCREMENT,
//                      blog_title text NOT NULL,
//                      blog_author text NOT NULL,
//                      blog_txt text NOT NULL,
//                      INSERT INTO myTable (blog_title, blog_author, blog_txt)
//                      VALUES ('Hello World', 'Darth Vader', 'This is the first post!'),
//                             ('Hello unviverse', 'Luke', 'I am in a swamp!');`,
//               () => {
//                 db.all(` SELECT blog_id, blog_title, blog_author, blog_txt FROM myTable`, (err, rows) => {
//                   res.render('index', { title: 'Blogging', data: rows });
//                 });
...
//       db.run(`INSERT INTO myTable (blog_title, blog_author, blog_txt) VALUES (?)`, [req.body.tblog, req.body.aublog, req.body.blog], 
//         function(err){
//           if (err) {
